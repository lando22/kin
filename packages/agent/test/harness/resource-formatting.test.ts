...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.kin/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.kin/skills/inspect/SKILL.md">\nReferences are relative to /project/.kin/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
