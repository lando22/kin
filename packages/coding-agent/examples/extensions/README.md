...
Example extensions for kin-coding-agent.
...
cp permission-gate.ts ~/.kin/agent/extensions/
```
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using kin-ai's built-in Anthropic/OpenAI streaming via proxy |
