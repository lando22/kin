...
```
~/.kin/agent/sessions/--<path>--/<timestamp>_<uuid>.jsonl
```
...
Sessions can be removed by deleting their `.jsonl` files under `~/.kin/agent/sessions/`.
...
Source on GitHub ([kin-mono](https://github.com/lando22/kin)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/lando22/kin/blob/main/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/lando22/kin/blob/main/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
- [`packages/ai/src/types.ts`](https://github.com/lando22/kin/blob/main/packages/ai/src/types.ts) - Base message types (UserMessage, AssistantMessage, ToolResultMessage)
- [`packages/agent/src/types.ts`](https://github.com/lando22/kin/blob/main/packages/agent/src/types.ts) - AgentMessage union type
...
### Base Message Types (from kin-ai)
...
### Extended Message Types (from kin-coding-agent)
