...
| Package | Purpose |
|---------|---------|
| `@earendil-works/kin-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@earendil-works/kin-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@earendil-works/kin-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@earendil-works/kin-coding-agent";
...
```typescript
import { isBashToolResult } from "@earendil-works/kin-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@earendil-works/kin-coding-agent";
...
```typescript
import { SessionManager } from "@earendil-works/kin-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@earendil-works/kin-tui";
...
```typescript
import { withFileMutationQueue } from "@earendil-works/kin-coding-agent";
...
**Important:** Use `StringEnum` from `@earendil-works/kin-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@earendil-works/kin-coding-agent";
...
```typescript
import { createBashTool } from "@earendil-works/kin-coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/earendil-works/kin-mono/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@earendil-works/kin-coding-agent";
...
```typescript
import { Text, Component } from "@earendil-works/kin-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@earendil-works/kin-coding-agent";
import { matchesKey } from "@earendil-works/kin-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@earendil-works/kin-coding-agent";
