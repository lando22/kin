...
- Built-in: `dark`, `light`
- Global: `~/.kin/agent/themes/*.json`
- Project: `.kin/themes/*.json`
...
```bash
mkdir -p ~/.kin/agent/themes
vim ~/.kin/agent/themes/my-theme.json
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/earendil-works/kin/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
