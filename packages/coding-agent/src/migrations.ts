...
const MIGRATION_GUIDE_URL = "https://github.com/lando22/kin/blob/main/packages/coding-agent/docs/extensions.md";
const EXTENSIONS_DOC_URL = "https://github.com/lando22/kin/blob/main/packages/coding-agent/docs/extensions.md";
