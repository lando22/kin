...
/** Drop all cached language services (used by tests). */
...
/**
 * Type-check one file after an edit. Returns a compact error listing for that file only,
 * or null when the file is clean, isn't TypeScript, or diagnostics aren't available
 * (no tsconfig, no project typescript, disabled, KIN_NO_EDIT_DIAGNOSTICS set).
 */
