...
export const MODELS = {
	...
	"openrouter": {
		...
		"deepseek/deepseek-v4-pro": {
			...
			provider: "openrouter",
			baseUrl: "https://openrouter.ai/api/v1",
			compat: {"openRouterRouting":{"only":["deepseek"],"allow_fallbacks":false},"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"deepseek"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"max"},
			input: ["text"],
			cost: {
		...
		"moonshotai/kimi-k2.6": {
			...
			provider: "openrouter",
			baseUrl: "https://openrouter.ai/api/v1",
			compat: {"openRouterRouting":{"only":["wandb/fp4"],"allow_fallbacks":false}},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.73,
