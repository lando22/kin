...
```bash
npm install @landongarrison/kin-ai
```

TypeBox exports are re-exported from `@landongarrison/kin-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@landongarrison/kin-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@landongarrison/kin-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@landongarrison/kin-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@landongarrison/kin-ai';
...
```typescript
import { getImageModel, generateImages } from '@landongarrison/kin-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@landongarrison/kin-ai';
...
```typescript
import { getModel, stream } from '@landongarrison/kin-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@landongarrison/kin-ai';
...
```typescript
import { Model, stream } from '@landongarrison/kin-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@landongarrison/kin-ai';
...
```typescript
import { getModel, complete, Context } from '@landongarrison/kin-ai';
...
```typescript
import { Context, getModel, complete } from '@landongarrison/kin-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@landongarrison/kin-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@landongarrison/kin-ai';
...
```bash
npx @landongarrison/kin-ai login              # interactive provider selection
npx @landongarrison/kin-ai login anthropic    # login to specific provider
npx @landongarrison/kin-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@landongarrison/kin-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@landongarrison/kin-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@landongarrison/kin-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@landongarrison/kin-ai`
