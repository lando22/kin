...
const agentDirEnvName = "KIN_CODING_AGENT_DIR";
...
Options:
  ...
  --agent-dir <dir>      Use a specific KIN_CODING_AGENT_DIR for the benchmark run
  --isolated-agent-dir   Use a fresh temporary agent dir instead of the normal one
  --no-offline           Do not force KIN_OFFLINE=1 / PI_SKIP_VERSION_CHECK=1
