...
tmux new-session -d -s kin-test -x 80 -y 24

# Start pi from source
tmux send-keys -t kin-test "cd /Users/badlogic/workspaces/kin-mono && ./kin-test.sh" Enter

# Wait for startup, then capture output
sleep 3 && tmux capture-pane -t kin-test -p

# Send input
tmux send-keys -t kin-test "your prompt here" Enter

# Send special keys
tmux send-keys -t kin-test Escape
tmux send-keys -t kin-test C-o  # ctrl+o

# Cleanup
tmux kill-session -t kin-test
```
...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/earendil-works/kin-mono/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/earendil-works/kin-mono/pull/456) by [@username](https://github.com/username))`
